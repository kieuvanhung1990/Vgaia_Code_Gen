...
/**
 * Cbo5900Input Class's Description <br>
 * Input State process of CboTCorporate_Info Class.
 * 
 * <p>
 ...
 */
public class Cbo5900Input extends Frw00AbstractBusinessState {
	...
	public void initState(String before) {
		Cbo5900Frame frame = (Cbo5900Frame) getBaseTemplateFrame();
		Cbo5900Panel clientArea = (Cbo5900Panel) getClientPanel();
