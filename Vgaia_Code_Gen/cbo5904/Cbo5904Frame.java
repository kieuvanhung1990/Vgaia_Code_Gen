 ...
 */
public class Cbo5904Frame extends Frw00BaseTemplateFrame implements
		ConstantValues {
	...
	public Dimension getInitialSize() {
		Dimension initialWindowSize = new Dimension(CBO_5904_WIDTH,
				CBO_5904_HEIGHT);
	 ...
	 * Define: <br>
	 * Imput state(Cbo5904Input) Change input state(Cbo5904ChangeInput) Confirm
	 * state(Cbo5904Confirm)) Result state(Cbo5904Result)
	 * 
	 * @param stateMap
