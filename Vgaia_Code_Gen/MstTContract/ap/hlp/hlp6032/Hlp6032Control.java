...
/**
 * Hlp6032Control class's Description. <br>
 ...
 */
public class Hlp6032Control extends RouteSelector {
     ...
     * 
     * @param input Frw00InputData {@link Hlp6032InputData}
     * @return result Frw00ResultData {@link Hlp6032ResultData}
    ...
    protected Frw00ResultData createResultData(Frw00InputData input)
        ...
        // Create result data
        Hlp6032ResultData result = new Hlp6032ResultData();
