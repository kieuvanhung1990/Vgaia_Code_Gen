...
/**
 * Hlp6032Input Class's Description <br>
 * Input State of Select MstTContract Class.
 * <p>
 ...
 */
public class Hlp6032Input extends Frw00AbstractBusinessState {

	////////// Class Variables //////////
	
	/** Control class name of AP side */
	private static final String BUSINESS_CLASS_NAME = "jp.co.okasan.ap.hlp.hlp6032.Hlp6032Control";
    ...
    public void initState(String before) {
    	Hlp6032Frame frame = (Hlp6032Frame) getBaseTemplateFrame();
	...
	public Frw00InputData getSendData() throws Frw10ClientException {
		...
		Hlp6032InputData inputData = new Hlp6032InputData();      
		// Get input data from screen to client area
		Hlp6032Panel clientArea = (Hlp6032Panel) getClientPanel();
	...
	public void setSuccessResultData(Frw00ResultData recvData)throws Frw10ClientException {
	    ...
	    Hlp6032ResultData resultData = (Hlp6032ResultData) recvData;
