...
/**
 * Hlp8904Control class's Description. <br>
 ...
 */
public class Hlp8904Control extends RouteSelector {
     ...
     * 
     * @param input Frw00InputData {@link Hlp8904InputData}
     * @return result Frw00ResultData {@link Hlp8904ResultData}
    ...
    protected Frw00ResultData createResultData(Frw00InputData input)
        ...
        // Create result data
        Hlp8904ResultData result = new Hlp8904ResultData();
