...
/**
 * Cbo5906AnswerOutput Class's Description. <br>
 * Answer output stage class.
 * 
 * @author: HungKieu 2016/04/19 Create New
 */
public class Cbo5906AnswerOutput {
	...
	public void doTask(Context ctx) throws SQLException {
		...
		// Get Response data
		Cbo5906ResultData resultData = context.getResultData();
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblId"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblContractNo"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblContractType"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblBondCd"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblSubAccoCd"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblQty"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblAmount"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblTaxAmt"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblInterestAmt"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblPaymentMethod"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblIntPaymentMethod"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblContractDate"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblPaymentCashDate"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblPaymentSecDate"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblTransactionCd"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblContractSts"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblStatus"), TITLE_WIDTH_COL1, ' '));
		...
		answer.append("\n");
		answer.append(Frw10StringUtil.rightPadByte(
				LanguageGetter.getProperty("Cbo5906Panel_lblRemarks"), TITLE_WIDTH_COL1, ' '));
