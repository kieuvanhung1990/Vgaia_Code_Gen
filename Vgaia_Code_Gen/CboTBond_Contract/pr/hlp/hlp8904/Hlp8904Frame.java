...
/**
 * Hlp8904Frame Class's Description. <br>
 * <P>
 * CboTBond_Contract class: select
 * 
 * @author: HungKieu 2016/04/15 Create New
 */
public class Hlp8904Frame extends Frw00HelpBaseTemplateFrame implements ConstantValues {
    ...
    public Hlp8904Frame(HashMap data, String businessId) {
        // Call from supper method
    ...
    protected Frw00BusinessStateManager createBusinessState(Frw00BusinessStateManager stateMap) {
		...
		stateMap.addBusinessState(new Hlp8904Input());
		return stateMap;
	}
