...
/**
 * Hlp8906Input Class's Description <br>
 ...
 */
public class Hlp8906Input extends Frw00AbstractBusinessState {

	////////// Class Variables //////////
	
	/** Control class name of AP side */
	private static final String BUSINESS_CLASS_NAME = "jp.co.okasan.ap.hlp.hlp8906.Hlp8906Control";
    ...
    public void initState(String before) {
    	Hlp8906Frame frame = (Hlp8906Frame) getBaseTemplateFrame();
	...
	public Frw00InputData getSendData() throws Frw10ClientException {
		...
		Hlp8906InputData inputData = new Hlp8906InputData();      
		// Get input data from screen to client area
		Hlp8906Panel clientArea = (Hlp8906Panel) getClientPanel();
	...
	public void setSuccessResultData(Frw00ResultData recvData)throws Frw10ClientException {
	    ...
	    Hlp8906ResultData resultData = (Hlp8906ResultData) recvData;
