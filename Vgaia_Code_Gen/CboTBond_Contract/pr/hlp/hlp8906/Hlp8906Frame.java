...
/**
 * Hlp8906Frame Class's Description. <br>
 * <P>
 * CboTBond_Contract class: select
 * 
 * @author: HungKieu 2016/04/19 Create New
 */
public class Hlp8906Frame extends Frw00HelpBaseTemplateFrame implements ConstantValues {
    ...
    public Hlp8906Frame(HashMap data, String businessId) {
        // Call from supper method
    ...
    protected Frw00BusinessStateManager createBusinessState(Frw00BusinessStateManager stateMap) {
		...
		stateMap.addBusinessState(new Hlp8906Input());
		return stateMap;
	}
